...
\captionsetup{labelformat=empty}
 \caption{La blockchain es una red distribuida, ni centralizada ni descentralizada.}
\end{figure}
...
\newpage 
\section{Apliaciones de la blockchain}
\begin{itemize}
